...
(let* ((bg "#1a1b1c")
      (err "#db6d6d")
      (err-container "#831212")
      (on-background "#cdc5bd")
      (on-err "#1a1b1c")
      (on-err-container "#f5d6d6")
      (on-primary "#1a1b1c")
      (on-primary-container "#f5d6d6")
      (on-secondary "#1a1b1c")
      (on-secondary-container "#f0e6db")
      (on-surface "#cdc5bd")
      (on-surface-variant "#a69d96")
      (on-tertiary "#1a1b1c")
      (on-tertiary-container "#e1e9ea")
      (outline-color "#656668")
      (outline-variant "#3f4041")
      (primary "#db6d6d")
      (primary-container "#831212")
      (secondary "#d1b394")
      (secondary-container "#8a5a28")
      (shadow "#000000")
      (surface "#1a1b1c")
      (surface-container "#252627")
      (surface-container-high "#2f3031")
      (surface-container-highest "#393a3c")
      (surface-container-low "#1f2021")
      (surface-container-lowest "#1c1d1e")
      (surface-variant "#252627")
      (tertiary "#8faeb1")
      (tertiary-container "#2f5a5e")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#8faeb1")
      (on-success "#1a1b1c")
      (success-container "#2f5a5e")
      (on-success-container "#e1e9ea")
      ;; Map fixed colors to regular colors
      (primary-fixed "#db6d6d")
      (primary-fixed-dim "#831212")
      (secondary-fixed "#d1b394")
      (secondary-fixed-dim "#8a5a28")
      (tertiary-fixed "#8faeb1")
      (tertiary-fixed-dim "#2f5a5e")
      (on-primary-fixed "#1a1b1c")
      (on-primary-fixed-variant "#f5d6d6")
      (on-secondary-fixed "#1a1b1c")
      (on-secondary-fixed-variant "#f0e6db")
      (on-tertiary-fixed "#1a1b1c")
      (on-tertiary-fixed-variant "#e1e9ea")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#cdc5bd")
      (inverse-primary "#db6d6d")
      (inverse-surface "#1a1b1c")
